        ...
        >
          ...
          >
            ...
            <li className="flex border-l  border-transparent hover:border-slate-900 dark:hover:border-slate-500 text-slate-700 dark:text-slate-200 dark:hover:text-white hover:text-black">
              <NavLink to="/libros" className="pl-3 flex my-3">
                <svg
                  className="fill-current w-5 h-5 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
            ...
            <li className="flex border-l  border-transparent hover:border-slate-900 dark:hover:border-slate-500 text-slate-700 dark:text-slate-200 dark:hover:text-white hover:text-black">
              <NavLink to="/escuelas" className="pl-3 flex my-3">
                <svg
                  className="fill-current w-5 h-5 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
            ...
            <li className="flex border-l  border-transparent hover:border-slate-900 dark:hover:border-slate-500 text-slate-700 dark:text-slate-200 dark:hover:text-white hover:text-black">
              <NavLink to="/terciarios" className="pl-3 flex my-3">
                <svg
                  className="fill-current w-5 h-5 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 512"
            ...
            <li className="flex border-l  border-transparent hover:border-slate-900 dark:hover:border-slate-500 text-slate-700 dark:text-slate-200 dark:hover:text-white hover:text-black">
              <NavLink to="/varios" className="pl-3 flex my-3">
                <svg
                  className="fill-current w-5 h-5 mr-2"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
